<?php $__env->startSection('title', 'نظام تتبع الأخطاء - Error Tracking'); ?>
                    ...
                    <div class="position-relative z-1">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-4">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <form action="<?php echo e(route('admin.errors.clear')); ?>" method="POST" onsubmit="return confirm('هل أنت متأكد من حذف جميع السجلات؟')">
                                    <?php echo csrf_field(); ?>
        ...
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h2 class="stat-value"><?php echo e($stats['total']); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h2 class="stat-value"><?php echo e($stats['today']); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h2 class="stat-value text-success"><?php echo e($stats['resolved']); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 mb-4">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h2 class="stat-value text-danger"><?php echo e($stats['unresolved']); ?></h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="glass-card overflow-hidden border-0">
                <div class="card-header-modern">
                    <div class="d-flex justify-content-between align-items-center px-4 py-3">
                        ...
                        <div class="badge-count"><?php echo e($logs->total()); ?> خطأ مسجل</div>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="table table-modern mb-0">
                            ...
                            <tr class="route-row">
                                <td>
                                    <div class="d-flex flex-column">
                                        <span class="text-danger fw-bold text-truncate" style="max-width: 400px;" title="<?php echo e($log->message); ?>">
                                            <?php echo e($log->message); ?>

                                        </span>
                                        <div class="d-flex align-items-center mt-1 gap-2">
                                            <span class="method-badge <?php echo e(strtolower($log->method)); ?>"><?php echo e($log->method); ?></span>
                                            <code class="text-muted small text-truncate" style="max-width: 300px;"><?php echo e($log->url); ?></code>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="d-flex flex-column">
                                        <span class="name-badge text-truncate" style="max-width: 200px;"><?php echo e(basename($log->file)); ?></span>
                                        <span class="text-muted small mt-1">Line: <?php echo e($log->line); ?></span>
                                    </div>
                                </td>
                                <td>
                                    <div class="text-dark small fw-medium"><?php echo e(\Carbon\Carbon::parse($log->created_at)->format('Y-m-d H:i:s')); ?></div>
                                    <div class="text-muted" style="font-size: 0.7rem;"><?php echo e(\Carbon\Carbon::parse($log->created_at)->diffForHumans()); ?></div>
                                </td>
                                ...
                                <td class="text-center">
                                    <div class="action-buttons">
                                        <button onclick="showDetails(<?php echo e($log->id); ?>)" class="btn-icon btn-view" title="عرض التفاصيل">
                                            <i class="fas fa-eye"></i>
                                        </button>
                                        <?php if(!$log->is_resolved): ?>
                                        <form action="<?php echo e(route('admin.errors.resolve', $log->id)); ?>" method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
...
document.getElementById('scanRoutesBtn').addEventListener('click', function() {
    ...
    fetch("<?php echo e(route('admin.errors.scan')); ?>")
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\larvel state big\resources\views/admin/errors/index.blade.php ENDPATH**/ ?>