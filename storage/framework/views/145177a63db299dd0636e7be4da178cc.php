<?php $__env->startSection('title', 'Edit Widget'); ?>
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <!-- Edit Form -->
        <form action="<?php echo e(route('admin.widgets.update', $widget)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <input type="text" name="title" value="<?php echo e(old('title', $widget->title)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <input type="text" name="slug" value="<?php echo e(old('slug', $widget->slug)); ?>" 
...
unset($__errorArgs, $__bag); ?> border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                            placeholder="Enter widget content..."><?php echo e(old('content', $widget->content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?> border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 font-mono text-sm"
                            placeholder='{"key": "value"}'><?php echo e(old('config', is_array($widget->config) ? json_encode($widget->config, JSON_PRETTY_PRINT) : $widget->config)); ?></textarea>
...
unset($__errorArgs, $__bag); ?> border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                                    ...
                                    <?php $__currentLoopData = $widgetTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key); ?>" <?php echo e(old('type', $widget->type) == $key ? 'selected' : ''); ?>><?php echo e($value); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?> border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                                    ...
                                    <?php $__currentLoopData = $positions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($key); ?>" <?php echo e(old('location', $widget->location) == $key ? 'selected' : ''); ?>><?php echo e($value); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" name="sort_order" value="<?php echo e(old('sort_order', $widget->sort_order)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                <label class="flex items-center">
                                    <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $widget->is_active) ? 'checked' : ''); ?> 
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6">
                        ...
                        <div class="space-y-3 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span class="font-medium"><?php echo e($widget->id); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Created:</span>
                                <span class="font-medium"><?php echo e($widget->created_at->format('Y-m-d H:i')); ?></span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Updated:</span>
                                <span class="font-medium"><?php echo e($widget->updated_at->format('Y-m-d H:i')); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\larvel state big\resources\views/admin/widgets/edit.blade.php ENDPATH**/ ?>