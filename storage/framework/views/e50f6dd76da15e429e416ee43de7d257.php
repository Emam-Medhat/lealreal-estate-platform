        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="page-header">
                    ...
                    <a href="<?php echo e(route('admin.properties.index')); ?>" class="btn-back">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <select class="form-select <?php $__errorArgs = ['property_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <option value="1" <?php echo e(old('property_type') == '1' ? 'selected' : ''); ?>>Apartment</option>
                                            <option value="2" <?php echo e(old('property_type') == '2' ? 'selected' : ''); ?>>Villa</option>
                                            <option value="3" <?php echo e(old('property_type') == '3' ? 'selected' : ''); ?>>House</option>
                                            <option value="4" <?php echo e(old('property_type') == '4' ? 'selected' : ''); ?>>Land</option>
                                            <option value="5" <?php echo e(old('property_type') == '5' ? 'selected' : ''); ?>>Commercial</option>
                                        </select>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <select class="form-select <?php $__errorArgs = ['listing_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <option value="sale" <?php echo e(old('listing_type') == 'sale' ? 'selected' : ''); ?>>For
                                                Sale</option>
                                            <option value="rent" <?php echo e(old('listing_type') == 'rent' ? 'selected' : ''); ?>>For
                                                Rent</option>
                                        </select>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" id="status"
                                            ...
                                            <option value="rented" <?php echo e(old('status') == 'rented' ? 'selected' : ''); ?>>Rented
                                            </option>
                                        </select>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="feature-toggles">
                                    <div class="toggle-item">
                                        <input type="checkbox" id="featured" name="featured" value="1" <?php echo e(old('featured') ? 'checked' : ''); ?>>
                                        <label for="featured">
                                    ...
                                    <div class="toggle-item">
                                        <input type="checkbox" id="premium" name="premium" value="1" <?php echo e(old('premium') ? 'checked' : ''); ?>>
                                        <label for="premium">
...
unset($__errorArgs, $__bag); ?>"
                                            id="city" name="city" value="<?php echo e(old('city')); ?>" placeholder="e.g., Riyadh"
                                            required>
                                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                            id="country" name="country" value="<?php echo e(old('country') ?? 'Saudi Arabia'); ?>"
                                            required>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon">
                                        <i class="fas fa-home"></i>
                                        <input type="text" class="form-control <?php $__errorArgs = ['neighborhood'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            id="neighborhood" name="neighborhood" value="<?php echo e(old('neighborhood')); ?>"
...
unset($__errorArgs, $__bag); ?>" id="latitude"
                                            name="latitude" value="<?php echo e(old('latitude')); ?>" placeholder="e.g., 24.7136">
                                    </div>
...
unset($__errorArgs, $__bag); ?>" id="longitude"
                                            name="longitude" value="<?php echo e(old('longitude')); ?>" placeholder="e.g., 46.6753">
                                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                            id="bedrooms" name="bedrooms" value="<?php echo e(old('bedrooms')); ?>" min="0"
                                            placeholder="0">
                                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                            id="bathrooms" name="bathrooms" value="<?php echo e(old('bathrooms')); ?>" min="0"
                                            placeholder="0">
                                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                            id="floors" name="floors" value="<?php echo e(old('floors')); ?>" min="0" placeholder="0">
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <input type="number"
                                            class="form-control <?php $__errorArgs = ['parking_spaces'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <input type="number" class="form-control <?php $__errorArgs = ['year_built'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            id="year_built" name="year_built" value="<?php echo e(old('year_built')); ?>" min="1900"
                                            max="<?php echo e(date('Y')); ?>" placeholder="<?php echo e(date('Y')); ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-with-icon">
                                            ...
                                            <input type="number" class="form-control <?php $__errorArgs = ['area'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                                id="area" name="area" value="<?php echo e(old('area')); ?>" required min="1"
                                                placeholder="1000">
                                        </div>
                                        <select class="form-select area-unit <?php $__errorArgs = ['area_unit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <option value="sq_m" <?php echo e(old('area_unit') == 'sq_m' ? 'selected' : ''); ?>>m²
                                            </option>
                                            <option value="sq_ft" <?php echo e(old('area_unit') == 'sq_ft' ? 'selected' : ''); ?>>ft²
                                            </option>
                                        </select>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" id="land_area"
                                                name="land_area" value="<?php echo e(old('land_area')); ?>" min="1" placeholder="1500">
                                        </div>
                                        <select class="form-select area-unit <?php $__errorArgs = ['land_area_unit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <option value="sq_m" <?php echo e(old('land_area_unit') == 'sq_m' ? 'selected' : ''); ?>>m²
                                            </option>
                                            <option value="sq_ft" <?php echo e(old('land_area_unit') == 'sq_ft' ? 'selected' : ''); ?>>ft²
                                            </option>
                                            <option value="acre" <?php echo e(old('land_area_unit') == 'acre' ? 'selected' : ''); ?>>acre
                                            </option>
                                            <option value="hectare" <?php echo e(old('land_area_unit') == 'hectare' ? 'selected' : ''); ?>>hectare</option>
                                        </select>
                                    </div>
                                ...
                                <div class="amenities-grid">
                                    <?php $__currentLoopData = $amenities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amenity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="amenity-checkbox">
                                            <input type="checkbox" name="amenities[]" value="<?php echo e($amenity->id); ?>" <?php echo e(in_array($amenity->id, old('amenities', [])) ? 'checked' : ''); ?>>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="amenities-grid">
                                    <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <label class="amenity-checkbox">
                                            <input type="checkbox" name="features[]" value="<?php echo e($feature->id); ?>" <?php echo e(in_array($feature->id, old('features', [])) ? 'checked' : ''); ?>>
                                            <span class="amenity-label">
                                                <?php if($feature->icon): ?>
                    ...
                    <div class="form-card-body">
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="url" class="form-control <?php $__errorArgs = ['virtual_tour_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    id="virtual_tour_url" name="virtual_tour_url" value="<?php echo e(old('virtual_tour_url')); ?>"
                                    placeholder="https://example.com/virtual-tour">
                            </div>
                            <?php $__errorArgs = ['virtual_tour_url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="price-input-group">
                                        <select class="currency-select <?php $__errorArgs = ['currency'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" id="price"
                                            name="price" value="<?php echo e(old('price')); ?>" required min="0" step="0.01"
                                            placeholder="0.00">
                                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <select class="form-select <?php $__errorArgs = ['payment_frequency'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <option value="annually" <?php echo e(old('payment_frequency') == 'annually' ? 'selected' : ''); ?>>Annually</option>
                                        </select>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="price-options">
                                    <label class="option-checkbox">
                                        <input type="checkbox" id="is_negotiable" name="is_negotiable" value="1" <?php echo e(old('is_negotiable') ? 'checked' : ''); ?>>
                                    ...
                                    <label class="option-checkbox">
                                        <input type="checkbox" id="includes_vat" name="includes_vat" value="1" <?php echo e(old('includes_vat') ? 'checked' : ''); ?>>
                                        <span class="option-label">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <input type="number"
                                            class="form-control <?php $__errorArgs = ['service_charges'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            id="service_charges" name="service_charges" value="<?php echo e(old('service_charges')); ?>"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <input type="number"
                                            class="form-control <?php $__errorArgs = ['maintenance_fees'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            value="<?php echo e(old('maintenance_fees')); ?>" min="0" step="0.01" placeholder="0.00">
                                    </div>
                                    <?php $__errorArgs = ['maintenance_fees'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\larvel state big\resources\views/admin/properties/create.blade.php ENDPATH**/ ?>