...
<?php $__env->startSection('title', 'Contact Us - Real Estate Pro'); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Property Listing" <?php echo e(old('subject') == 'Property Listing' ? 'selected' : ''); ?>>Property Listing</option>
                                <option value="Agent Services" <?php echo e(old('subject') == 'Agent Services' ? 'selected' : ''); ?>>Agent Services</option>
                ...
                <div>
                    ...
                    <div class="mt-12">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <a href="<?php echo e(route('properties.index')); ?>" class="text-blue-600 hover:text-blue-700 flex items-center">
                                <i class="fas fa-home mr-2"></i>
                                Browse Properties
                            </a>
                            <a href="<?php echo e(route('agents.directory')); ?>" class="text-blue-600 hover:text-blue-700 flex items-center">
                                <i class="fas fa-users mr-2"></i>
                                Find Agents
                            </a>
                            <a href="<?php echo e(route('about')); ?>" class="text-blue-600 hover:text-blue-700 flex items-center">
                                <i class="fas fa-info-circle mr-2"></i>
                                About Us
                            </a>
                            <a href="<?php echo e(route('login')); ?>" class="text-blue-600 hover:text-blue-700 flex items-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\larvel state big\resources\views/contact/index.blade.php ENDPATH**/ ?>