...
<?php $__env->startSection('title', 'System Backups'); ?>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800"><?php echo e(count($backups)); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-800"><?php echo e($backups[0]->created_at->diffForHumans()); ?></p>
                    </div>
                </div>
            </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-sm text-gray-500">ID: <?php echo e($backup->id); ?></div>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm text-gray-900"><?php echo e($backup->size); ?></span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                        <?php echo e($backup->type === 'full' ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'); ?>">
                                        <?php echo e(ucfirst($backup->type)); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                    <?php echo e($backup->created_at->format('M j, Y H:i')); ?>

                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="<?php echo e(route('admin.backups.download', $backup->id)); ?>" class="text-blue-600 hover:text-blue-900 mr-3">
                                        <i class="fas fa-download"></i> Download
                                    </a>
                                    <button class="text-red-600 hover:text-red-900" onclick="restoreBackup(<?php echo e($backup->id); ?>)">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\larvel state big\resources\views/admin/backups/index.blade.php ENDPATH**/ ?>