...
<?php $__env->startSection('title', 'لوحة تحكم البلوكشين'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <a href="<?php echo e(url('blockchain/wallets')); ?>" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 transition-colors duration-200">
        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold"><?php echo e(number_format($stats['total_blocks'] ?? 0)); ?></p>
        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold"><?php echo e(number_format($stats['total_transactions'] ?? 0)); ?></p>
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold"><?php echo e(number_format($stats['total_contracts'] ?? 0)); ?></p>
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold"><?php echo e(number_format($stats['total_wallets'] ?? 0)); ?></p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="text-center">
                    <div class="bg-gray-50 rounded-xl p-4">
                        ...
                        <p class="text-xl font-bold text-gray-900"><?php echo e($stats['latest_block']->height ?? 'N/A'); ?></p>
                    </div>
                </div>
                ...
                <div class="text-center">
                    <div class="bg-gray-50 rounded-xl p-4">
                        ...
                        <p class="text-xl font-bold text-gray-900"><?php echo e($stats['network_hashrate'] ?? 'N/A'); ?></p>
                    </div>
                </div>
                ...
                <div class="text-center">
                    <div class="bg-gray-50 rounded-xl p-4">
                        ...
                        <p class="text-xl font-bold text-gray-900"><?php echo e(number_format($stats['difficulty'] ?? 0)); ?></p>
                    </div>
                </div>
                ...
                <div class="text-center">
                    <div class="bg-gray-50 rounded-xl p-4">
                        ...
                        <p class="text-xl font-bold text-gray-900"><?php echo e($stats['gas_price'] ?? 0); ?> Gwei</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="p-6">
                <div class="space-y-4">
                    <?php $__empty_1 = true; $__currentLoopData = $recentBlocks ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                        <div class="flex items-center space-x-4 space-x-reverse">
                            ...
                            <div>
                                <p class="font-semibold text-gray-900">كتلة #<?php echo e($block->height ?? 'N/A'); ?></p>
                                <p class="text-sm text-gray-500"><?php echo e($block->created_at->diffForHumans() ?? 'الآن'); ?></p>
                            </div>
                        </div>
                        <div class="text-left">
                            <p class="text-sm text-gray-600"><?php echo e($block->transaction_count ?? 0); ?> معاملة</p>
                            <p class="text-xs text-gray-400 font-mono"><?php echo e(substr($block->hash ?? '', 0, 10)); ?>...</p>
                        </div>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors duration-200">
                        <div class="flex items-center space-x-4 space-x-reverse">
                            ...
                            <div>
                                <p class="font-semibold text-gray-900"><?php echo e($transaction->amount ?? 0); ?> ETH</p>
                                <p class="text-sm text-gray-500"><?php echo e($transaction->created_at->diffForHumans() ?? 'الآن'); ?></p>
                            </div>
                        </div>
                        <div class="text-left">
                            <p class="text-xs text-gray-400 font-mono"><?php echo e(substr($transaction->hash ?? '', 0, 10)); ?>...</p>
                            <p class="text-xs text-gray-500"><?php echo e(substr($transaction->from_address ?? '', 0, 8)); ?> → <?php echo e(substr($transaction->to_address ?? '', 0, 8)); ?></p>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="text-center py-8">
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\larvel state big\resources\views/blockchain/dashboard.blade.php ENDPATH**/ ?>