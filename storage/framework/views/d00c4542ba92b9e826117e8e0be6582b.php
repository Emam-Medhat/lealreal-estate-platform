<?php $__env->startSection('title', 'تخزين الأصول - Staking'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="<?php echo e(route('blockchain.defi.lending')); ?>" class="inline-flex items-center px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 transition-colors duration-200">
                    <i class="fas fa-hand-holding-usd ml-2"></i>
                    القروض
                </a>
                <a href="<?php echo e(route('blockchain.defi.staking')); ?>" class="inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-colors duration-200">
        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold"><?php echo e($activeStakes); ?></p>
        ...
        <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02]">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold"><?php echo e(number_format($totalStaked * ($averageAPY / 100) / 365, 4)); ?> ETH</p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <?php $__currentLoopData = $stakingPools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pool): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="p-6">
                <div class="space-y-3 mb-4">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="font-semibold"><?php echo e(ucfirst($pool->protocol)); ?></span>
                    </div>
                </div>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\larvel state big\resources\views/blockchain/defi/staking.blade.php ENDPATH**/ ?>