<?php $__env->startSection('title', 'لوحة العملاء المحتملين'); ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_leads']); ?></p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-blue-600"><?php echo e($stats['new_leads']); ?></p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-green-600"><?php echo e($stats['qualified_leads']); ?></p>
            </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-2xl font-bold text-purple-600"><?php echo e($stats['converted_leads']); ?></p>
            </div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
    <div class="flex items-center justify-between">
        ...
        <div class="text-right">
            <p class="text-3xl font-bold text-orange-600"><?php echo e(number_format($stats['conversion_rate'], 2)); ?>%</p>
    ...
    <div class="mt-4">
        <div class="w-full bg-gray-200 rounded-full h-2">
            <div class="bg-gradient-to-r from-orange-500 to-orange-600 h-2 rounded-full transition-all duration-500" 
                 style="width: <?php echo e(min($stats['conversion_rate'], 100)); ?>%"></div>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <?php $__empty_1 = true; $__currentLoopData = $leadSources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $source): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <span class="text-sm font-medium text-gray-700"><?php echo e($source->name); ?></span>
                    </div>
                    <div class="text-right">
                        <span class="text-sm font-semibold text-gray-900"><?php echo e($source->leads_count); ?></span>
                    </div>
                </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="space-y-3">
            <?php $__empty_1 = true; $__currentLoopData = $leadStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        <div class="w-3 h-3 rounded-full mr-3" style="background-color: <?php echo e($status->color); ?>"></div>
                        <span class="text-sm font-medium text-gray-700"><?php echo e($status->name); ?></span>
                    </div>
                    <div class="text-right">
                        <span class="text-sm font-semibold text-gray-900"><?php echo e($status->leads_count); ?></span>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <p class="text-gray-500 text-sm">لا توجد بيانات</p>
            ...
            <div class="px-6 py-4 hover:bg-gray-50 border-b border-gray-100 last:border-b-0 transition-colors">
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4 space-x-reverse">
                        ...
                        <div>
                            <h4 class="text-sm font-medium text-gray-900"><?php echo e($lead->first_name); ?> <?php echo e($lead->last_name); ?></h4>
                    ...
                    <div class="flex items-center space-x-2 space-x-reverse">
                        <?php if($lead->status): ?>
                            <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium" 
                                  style="background-color: <?php echo e($lead->status->color); ?>20; color: <?php echo e($lead->status->color); ?>">
                                <?php echo e($lead->status->name); ?>

                            </span>
                        <?php endif; ?>
                        <span class="text-xs text-gray-500"><?php echo e($lead->created_at->format('Y-m-d')); ?></span>
                    </div>
                </div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\larvel state big\resources\views/leads/dashboard.blade.php ENDPATH**/ ?>