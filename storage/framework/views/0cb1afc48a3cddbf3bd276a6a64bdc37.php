        ...
        <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="allow_registration" <?php echo e($settings['allow_registration'] ? 'checked' : ''); ?> 
                                   class="sr-only peer">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <label class="relative inline-flex items-center cursor-pointer">
                            <input type="checkbox" name="email_verification" <?php echo e($settings['email_verification'] ? 'checked' : ''); ?> 
                                   class="sr-only peer">
                            <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                        </label>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" name="max_file_size" value="<?php echo e($settings['max_file_size']); ?>" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                    </div>
                    ...
                    <div>
                        ...
                        <select name="supported_formats[]" multiple 
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">
                            <option value="jpg" <?php echo e(in_array('jpg', $settings['supported_formats']) ? 'selected' : ''); ?>>JPG</option>
                            <option value="jpeg" <?php echo e(in_array('jpeg', $settings['supported_formats']) ? 'selected' : ''); ?>>JPEG</option>
                            <option value="png" <?php echo e(in_array('png', $settings['supported_formats']) ? 'selected' : ''); ?>>PNG</option>
                            <option value="pdf" <?php echo e(in_array('pdf', $settings['supported_formats']) ? 'selected' : ''); ?>>PDF</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <label class="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="maintenance_mode" <?php echo e($settings['maintenance_mode'] ? 'checked' : ''); ?> 
                               class="sr-only peer">
                        <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
                    </label>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\larvel state big\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>