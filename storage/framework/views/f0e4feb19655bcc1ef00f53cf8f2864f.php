...
<?php $__env->startSection('title', 'Widget Management'); ?>
...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-2">
                    ...
                    <a href="<?php echo e(route('admin.widgets.create')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    ...
                    <input type="text" placeholder="Search widgets..." value="<?php echo e(request('search')); ?>" 
                ...
                <div>
                    ...
                    <select name="type" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <option value="form" <?php echo e(request('type') == 'form' ? 'selected' : ''); ?>>Form</option>
                        <option value="social" <?php echo e(request('type') == 'social' ? 'selected' : ''); ?>>Social Media</option>
                        <option value="custom" <?php echo e(request('type') == 'custom' ? 'selected' : ''); ?>>Custom</option>
                    </select>
                </div>
                <div>
                    ...
                    <select name="location" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <option value="header" <?php echo e(request('location') == 'header' ? 'selected' : ''); ?>>Header</option>
                        <option value="sidebar_left" <?php echo e(request('location') == 'sidebar_left' ? 'selected' : ''); ?>>Sidebar Left</option>
                        <option value="sidebar_right" <?php echo e(request('location') == 'sidebar_right' ? 'selected' : ''); ?>>Sidebar Right</option>
                        <option value="footer" <?php echo e(request('location') == 'footer' ? 'selected' : ''); ?>>Footer</option>
                        <option value="content_top" <?php echo e(request('location') == 'content_top' ? 'selected' : ''); ?>>Content Top</option>
                        <option value="content_bottom" <?php echo e(request('location') == 'content_bottom' ? 'selected' : ''); ?>>Content Bottom</option>
                    </select>
                </div>
                <div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
                            ...
                            <div class="flex items-start justify-between">
                                <div class="flex items-center">
                                    <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center mr-3">
                                        <i class="fas <?php echo e($widget->type === 'text' ? 'fa-font text-blue-600' : ($widget->type === 'image' ? 'fa-image text-green-600' : ($widget->type === 'video' ? 'fa-video text-red-600' : ($widget->type === 'form' ? 'fa-wpforms text-purple-600' : ($widget->type === 'social' ? 'fa-share-alt text-yellow-600' : 'fa-cube text-gray-600'))))); ?> text-lg"></i>
                                    </div>
                                    <div>
                                        <h3 class="text-lg font-semibold text-gray-800"><?php echo e($widget->title); ?></h3>
                                        <p class="text-sm text-gray-500"><?php echo e($widget->type); ?></p>
                                    </div>
                                </div>
                                <div class="flex items-center space-x-2">
                                    <input type="checkbox" class="widget-checkbox" value="<?php echo e($widget->id); ?>" 
                                        class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                                    <button onclick="toggleWidget(<?php echo e($widget->id); ?>)" class="p-1 rounded hover:bg-gray-200">
                                        <i class="fas <?php echo e($widget->is_active ? 'fa-eye text-blue-600' : 'fa-eye-slash text-gray-400'); ?>"></i>
                                    </button>
                                    <a href="<?php echo e(route('admin.widgets.edit', $widget)); ?>" class="text-gray-600 hover:text-gray-800">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button onclick="duplicateWidget(<?php echo e($widget->id); ?>)" class="text-purple-600 hover:text-purple-800">
                                        <i class="fas fa-copy"></i>
                                    </button>
                                    <button onclick="deleteWidget(<?php echo e($widget->id); ?>)" class="text-red-600 hover:text-red-800">
                        ...
                        <div class="p-4">
                            <?php if($widget->type === 'text'): ?>
                                <div class="text-sm text-gray-600">
                                    <?php echo e(Str::limit($widget->content ?? 'No content', 100)); ?>

                                </div>
                            <?php elseif($widget->type === 'image'): ?>
                                <div class="text-center">
                                    <?php if($widget->image_url): ?>
                                        <img src="<?php echo e($widget->image_url); ?>" alt="<?php echo e($widget->name); ?>" 
                            ...
                            <?php elseif($widget->type === 'form'): ?>
                                <div class="text-center">
                                    <i class="fas fa-wpforms text-gray-400 text-3xl mb-2"></i>
                                    <p class="text-sm text-gray-600"><?php echo e($widget->form_type ?? 'Contact'); ?> Form</p>
                                </div>
                            <?php else: ?>
                                <div class="text-center">
                            ...
                            <div class="flex items-center justify-between text-sm">
                                <div class="flex items-center space-x-4">
                                    <span class="text-gray-500">
                                        ...
                                        <?php echo e($widget->location); ?>

                                    </span>
                                    <span class="text-gray-500">
                                        <i class="fas fa-layer-group mr-1"></i>
                                        Order: <?php echo e($widget->sort_order); ?>

                                    </span>
                                </div>
                                <span class="px-2 py-1 text-xs font-semibold rounded-full 
                                    <?php echo e($widget->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
            ...
            <!-- Pagination -->
            <?php if(isset($widgets) && $widgets->hasPages()): ?>
                <div class="mt-8">
...
function bulkActivate() {
    ...
    fetch('<?php echo e(route('admin.widgets.bulk-toggle')); ?>', {
        method: 'POST',
        headers: {
...
function bulkDelete() {
    ...
    if (confirm(`Are you sure you want to delete ${selected.length} widget(s)?`)) {
        fetch('<?php echo e(route('admin.widgets.bulk-delete')); ?>', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\larvel state big\resources\views/admin/widgets/index.blade.php ENDPATH**/ ?>