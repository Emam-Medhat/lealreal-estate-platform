            ...
            <div class="card bg-gradient-primary text-white border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="card-title mb-1"><?php echo e($stats['total_properties']); ?></h3>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-gradient-success text-white border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="card-title mb-1"><?php echo e($stats['active_monitoring']); ?></h3>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-gradient-warning text-white border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="card-title mb-1"><?php echo e(number_format($stats['total_consumption'], 1)); ?></h3>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="card bg-gradient-info text-white border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h3 class="card-title mb-1">$<?php echo e(number_format($stats['energy_savings'], 0)); ?></h3>
                ...
                <div class="card-body p-0">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <?php if($recentData->count() > 0): ?>
                                    <?php $__currentLoopData = $recentData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="border-bottom">
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <div class="fw-medium"><?php echo e($data->property->property ? $data->property->property->title : 'Property ' . $data->property_id); ?></div>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="fw-bold"><?php echo e(number_format($data->consumption_kwh, 2)); ?></span>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="fw-bold text-success"><?php echo e(number_format($data->savings_amount, 2)); ?></span>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="progress flex-grow-1 me-2" style="height: 8px;">
                                                        <div class="progress-bar bg-<?php echo e($data->efficiency_score >= 80 ? 'success' : ($data->efficiency_score >= 60 ? 'warning' : 'danger')); ?>" 
                                                             style="width: <?php echo e($data->efficiency_score); ?>%">
                                                        </div>
                                                    </div>
                                                    <span class="small fw-medium"><?php echo e(number_format($data->efficiency_score, 1)); ?>%</span>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="badge bg-<?php echo e($data->status == 'active' ? 'success' : ($data->status == 'inactive' ? 'secondary' : 'warning')); ?> rounded-pill">
                                            ...
                                            <td>
                                                <small class="text-muted">
                                                    ...
                                                    <?php echo e($data->last_reading_at ? \Carbon\Carbon::parse($data->last_reading_at)->format('M j, H:i') : 'Never'); ?>

                                                </small>
                                            </td>
                                            <td>
                                                <div class="btn-group btn-group-sm" role="group">
                                                    <button class="btn btn-outline-primary btn-sm" onclick="viewDetails(<?php echo e($data->id); ?>)" title="View Details">
                                                        <i class="fas fa-eye"></i>
                                                    </button>
                                                    <button class="btn btn-outline-warning btn-sm" onclick="editData(<?php echo e($data->id); ?>)" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </button>
                                                    <button class="btn btn-outline-danger btn-sm" onclick="deleteData(<?php echo e($data->id); ?>)" title="Delete">
                ...
                <div class="card-body">
                    <div class="small">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="fw-medium"><?php echo e(number_format($stats['average_daily'], 2)); ?> kWh</span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span class="text-muted">Efficiency Score:</span>
                            <span class="fw-medium"><?php echo e(number_format($stats['efficiency_score'], 1)); ?>%</span>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="text-muted">Last Updated:</span>
                            <span class="fw-medium"><?php echo e(now()->format('H:i')); ?></span>
                        </div>
                    </div>
                </div>
            </div>
...
function addMonitoring() {
    window.location.href = '<?php echo e(route('iot.energy.create')); ?>';
}
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\larvel state big\resources\views/iot/energy-monitoring/dashboard.blade.php ENDPATH**/ ?>