<?php $__env->startSection('title', 'نماذج BIM'); ?>
...
<div class="container-fluid px-4 py-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['total_models'] ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e($stats['active_models'] ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e(number_format(($stats['total_files_size'] ?? 0) / 1024 / 1024, 1)); ?> MB</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900"><?php echo e(number_format($stats['avg_review_score'] ?? 0, 1)); ?></p>
                </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <?php if($recentModels->count() > 0): ?>
                        <?php $__currentLoopData = $recentModels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $model): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <p class="font-medium text-gray-900"><?php echo e($model->name ?? 'نموذج بدون اسم'); ?></p>
                                        <p class="text-sm text-gray-600"><?php echo e($model->version ?? 'v1.0'); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm text-gray-900"><?php echo e($model->company_name ?? 'N/A'); ?></span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm text-gray-900"><?php echo e(number_format(($model->file_size ?? 0) / 1024 / 1024, 1)); ?> MB</span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-2 py-1 text-xs rounded-full 
                                    <?php if($model->status == 'published'): ?> bg-green-100 text-green-800
                                    <?php elseif($model->status == 'draft'): ?> bg-gray-100 text-gray-800
                                    <?php else: ?> bg-yellow-100 text-yellow-800 <?php endif; ?>">
                                    <?php echo e($model->status ?? 'draft'); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex text-yellow-400">
                                        <?php for($i = 1; $i <= 5; $i++): ?>
                                            <i class="fas fa-star <?php echo e($i <= ($model->review_score ?? 0) ? '' : 'text-gray-300'); ?> text-sm"></i>
                                        <?php endfor; ?>
                                    </div>
                                    <span class="text-sm text-gray-600 mr-2"><?php echo e($model->review_score ?? 0); ?>.0</span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <p class="text-sm text-gray-900"><?php echo e($model->created_at ? $model->created_at->format('Y-m-d') : 'N/A'); ?></p>
                            </td>
    ...
    <script>
        ...
        function exportModels() {
            window.open('<?php echo e(route("developer.bim.models.export")); ?>', '_blank');
        }
        ...
        document.getElementById('uploadForm').addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route("developer.bim.models.upload")); ?>', {
                method: 'POST',
                body: formData,
                headers: {
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\larvel state big\resources\views/developer/bim-models.blade.php ENDPATH**/ ?>