<?php $__env->startSection('title', 'تقارير الصيانة'); ?>

<?php $__env->startSection('page-title', 'تقارير الصيانة'); ?>
    ...
    <div class="bg-blue-600 rounded-lg shadow-sm p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-white mt-2"><?php echo e(App\Models\WorkOrder::count()); ?></p>
            </div>
    ...
    <div class="bg-green-600 rounded-lg shadow-sm p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-white mt-2"><?php echo e(App\Models\WorkOrder::where('status', 'completed')->count()); ?></p>
            </div>
    ...
    <div class="bg-amber-600 rounded-lg shadow-sm p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-white mt-2"><?php echo e(App\Models\WorkOrder::where('status', 'in_progress')->count()); ?></p>
            </div>
    ...
    <div class="bg-purple-600 rounded-lg shadow-sm p-6">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-3xl font-bold text-white mt-2"><?php echo e(App\Models\MaintenanceTeam::count()); ?></p>
            </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div class="p-6">
            <div class="space-y-3">
                <a href="<?php echo e(route('maintenance.reports.workorders')); ?>" class="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                ...
                <a href="<?php echo e(route('maintenance.reports.teams')); ?>" class="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    <div class="flex items-center">
                ...
                <a href="<?php echo e(route('maintenance.reports.performance')); ?>" class="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    <div class="flex items-center">
                ...
                <a href="<?php echo e(route('maintenance.reports.costs')); ?>" class="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    <div class="flex items-center">
        ...
        <div class="p-6">
            <?php
                $recentWorkOrders = App\Models\WorkOrder::with(['property', 'assignedTeam'])
                    ...
                    ->get();
            ?>
            <?php if($recentWorkOrders->count() > 0): ?>
                <div class="space-y-4">
                    <?php $__currentLoopData = $recentWorkOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workOrder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex-1">
                                <h4 class="text-sm font-medium text-gray-900"><?php echo e($workOrder->title); ?></h4>
                                <p class="text-xs text-gray-500 mt-1">
                                    <?php echo e($workOrder->property->title ?? 'N/A'); ?> - 
                                    <?php echo e($workOrder->assignedTeam->name ?? 'غير محدد'); ?>

                                </p>
                            </div>
                            <div class="mr-3">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    <?php if($workOrder->status == 'completed'): ?> bg-green-100 text-green-800
                                    <?php elseif($workOrder->status == 'in_progress'): ?> bg-amber-100 text-amber-800
                                    <?php else: ?> bg-gray-100 text-gray-800 <?php endif; ?>">
                                    <?php echo e(__('maintenance.workorders.status_' . $workOrder->status)); ?>
...
<?php echo $__env->make('admin.layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\larvel state big\resources\views/maintenance/reports/index.blade.php ENDPATH**/ ?>