<?php $__env->startSection('title', __('Home') . ' | ' . config('app.name', 'Real Estate Pro')); ?>
    ...
    <section class="relative min-h-[90vh] flex items-center justify-center text-white overflow-hidden">
        ...
        <div class="absolute inset-0 z-0">
            <img src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80" 
                 alt="<?php echo e(__('Luxury Properties Landscape')); ?>" 
            ...
            <div class="max-w-5xl mx-auto">
                ...
                <div class="inline-flex items-center space-x-3 bg-white/10 backdrop-blur-xl rounded-full px-6 py-2.5 mb-10 border border-white/20 shadow-2xl animate-fade-in-down">
                    <div class="flex -space-x-2">
                        <?php for($i = 1; $i <= 3; $i++): ?>
                            <img src="https://ui-avatars.com/api/?name=User+<?php echo e($i); ?>&background=random" class="w-8 h-8 rounded-full border-2 border-white/20 object-cover" alt="User Badge">
                        <?php endfor; ?>
                    </div>
                    <span class="text-sm font-semibold tracking-wide uppercase"><?php echo e(__('Trusted by 50K+ Clients Worldwide')); ?></span>
                </div>

                <!-- Visionary Headline -->
                <h1 class="text-5xl md:text-7xl lg:text-8xl font-black mb-8 leading-tight animate-fade-in">
                    <?php echo e(__('Find Your')); ?> <br>
                    <span class="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-300 to-indigo-400">
                        <?php echo e(__('Architectural Dream')); ?>
                ...
                <p class="text-xl md:text-2xl text-slate-300 mb-14 max-w-3xl leading-relaxed font-light animate-fade-in delay-200">
                    <?php echo e(__('Experience a new standard of property acquisition. Premium estates, verified listings, and a seamless digital journey designed for the elite.')); ?>
                    ...
                    <div class="p-4 md:p-6 lg:p-8">
                        ...
                        <div class="flex space-x-2 mb-8 bg-black/20 p-1.5 rounded-2xl w-fit">
                            ...
                            <?php $__currentLoopData = $tabs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $tab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button class="px-8 py-3 rounded-xl transition-all duration-500 font-bold uppercase tracking-widest text-xs <?php echo e($idx === 0 ? 'bg-blue-600 text-white shadow-xl shadow-blue-500/30' : 'text-slate-400 hover:text-white hover:bg-white/5'); ?>">
                                    <?php echo e(__($tab)); ?>
                        ...
                        <form action="<?php echo e(route('properties.index')); ?>" method="GET" class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" name="location" placeholder="<?php echo e(__('Where do you want to live?')); ?>" 
                                ...
                                <div class="relative group">
                                    ...
                                    <select name="property_type" class="block w-full pl-16 pr-6 py-6 bg-white/10 border border-white/10 rounded-3xl text-white appearance-none focus:outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500/50 transition-all duration-300 text-lg">
                                        <option value="" class="bg-slate-900"><?php echo e(__('All Architecture')); ?></option>
                                        <option value="villa" class="bg-slate-900"><?php echo e(__('Modern Villas')); ?></option>
                                        <option value="apartment" class="bg-slate-900"><?php echo e(__('Penthouses')); ?></option>
                                        <option value="house" class="bg-slate-900"><?php echo e(__('Single Houses')); ?></option>
                                        <option value="office" class="bg-slate-900"><?php echo e(__('Smart Offices')); ?></option>
                                    </select>
                                </div>
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" name="price_range" placeholder="<?php echo e(__('Investment Range')); ?>" 
                                           class="block w-full pl-16 pr-6 py-6 bg-white/10 border border-white/10 rounded-3xl text-white placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-blue-500/20 focus:border-blue-500/50 transition-all duration-300 text-lg">
                                </div>
                                ...
                                <button type="submit" class="relative overflow-hidden group/btn bg-gradient-to-r from-blue-600 to-indigo-600 py-6 px-10 rounded-3xl font-black text-xl shadow-[0_15px_30px_rgba(37,99,235,0.4)] hover:shadow-[0_20px_40px_rgba(37,99,235,0.6)] transition-all duration-500 transform hover:-translate-y-1">
                                    ...
                                    <span class="relative flex items-center justify-center space-x-3">
                                        ...
                                        <span><?php echo e(__('Discover')); ?></span>
                                    </span>
                                </button>
                            </div>
                        </form>
                ...
                <div class="mt-12 flex flex-wrap gap-8 animate-fade-in delay-500">
                    <a href="#" class="flex items-center space-x-3 text-slate-300 hover:text-white transition-all group">
                        ...
                        <span class="font-bold tracking-tight"><?php echo e(__('Market Hot Deals')); ?></span>
                    </a>
                    <a href="#" class="flex items-center space-x-3 text-slate-300 hover:text-white transition-all group">
                        ...
                        <span class="font-bold tracking-tight"><?php echo e(__('Premium Collection')); ?></span>
                    </a>
                    <a href="#" class="flex items-center space-x-3 text-slate-300 hover:text-white transition-all group">
                        ...
                        <span class="font-bold tracking-tight"><?php echo e(__('Interactive Map Search')); ?></span>
                    </a>
                </div>
            </div>
        </div>
                ...
                <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="relative group">
                        <div class="mb-6 mx-auto w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:border-blue-500/50">
                            <i class="fas <?php echo e($stat['icon']); ?> text-2xl bg-clip-text text-transparent bg-gradient-to-r <?php echo e($stat['color']); ?>"></i>
                        </div>
                        <div class="text-4xl lg:text-6xl font-black text-white mb-2 tracking-tighter" data-counter="<?php echo e($stat['value']); ?>">0</div>
                        <div class="text-slate-400 font-bold uppercase tracking-widest text-xs"><?php echo e(__($stat['label'])); ?></div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        ...
        <div class="container mx-auto px-6 relative">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-20">
                <div class="max-w-3xl">
                    <div class="inline-block px-4 py-1.5 bg-blue-100 rounded-full text-blue-600 text-xs font-black uppercase tracking-widest mb-6">
                        <?php echo e(__('Exquisite Selection')); ?>

                    </div>
                    <h2 class="text-4xl md:text-6xl font-black text-slate-900 mb-8 leading-tight tracking-tight">
                        <?php echo e(__('Featured Masterpieces')); ?>

                    </h2>
                    <p class="text-lg text-slate-500 leading-relaxed font-medium">
                        <?php echo e(__('Dive into our handpicked collection of architectural marvels. Each property is a testament to luxury, comfort, and unparalleled design.')); ?>

                    </p>
                </div>
                <a href="<?php echo e(route('properties.index', ['featured' => 1])); ?>" class="mt-10 md:mt-0 group/link flex items-center space-x-4 bg-white px-8 py-5 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-x-2 border border-slate-100">
                    <span class="font-black text-slate-900 uppercase tracking-widest text-sm underline decoration-blue-500 decoration-4 underline-offset-8"><?php echo e(__('Explore Full Catalog')); ?></span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
                <?php $__empty_1 = true; $__currentLoopData = $featuredProperties ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $property): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php if (isset($component)) { $__componentOriginalf3d0335150bc4ffc8c432f112a3e4903 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf3d0335150bc4ffc8c432f112a3e4903 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.property-premium-card','data' => ['property' => $property]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('property-premium-card'); ?>
...
<?php endif; ?>
<?php if (isset($__attributesOriginalf3d0335150bc4ffc8c432f112a3e4903)): ?>
<?php $attributes = $__attributesOriginalf3d0335150bc4ffc8c432f112a3e4903; ?>
<?php unset($__attributesOriginalf3d0335150bc4ffc8c432f112a3e4903); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalf3d0335150bc4ffc8c432f112a3e4903)): ?>
<?php $component = $__componentOriginalf3d0335150bc4ffc8c432f112a3e4903; ?>
<?php unset($__componentOriginalf3d0335150bc4ffc8c432f112a3e4903); ?>
<?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    ...
                    <?php for($i = 1; $i <= 4; $i++): ?>
                        <div class="group relative bg-white rounded-[2.5rem] overflow-hidden shadow-[0_15px_40px_-15px_rgba(0,0,0,0.1)] hover:shadow-[0_40px_70px_-20px_rgba(0,0,0,0.15)] transition-all duration-700 transform hover:-translate-y-4">
                                ...
                                <div class="absolute bottom-6 left-6 right-6">
                                    <div class="bg-white/10 backdrop-blur-2xl border border-white/20 p-4 rounded-3xl flex justify-between items-center shadow-2xl">
                                        <div class="text-white">
                                            <div class="text-[10px] font-black uppercase tracking-widest opacity-70"><?php echo e(__('Investment')); ?></div>
                                            <div class="text-2xl font-black">$<?php echo e(number_format(1500000 + ($i * 250000))); ?></div>
                                        </div>
                            ...
                            <!-- Content Interface -->
                            <div class="p-8">
                                <h3 class="text-2xl font-black text-slate-900 mb-2 truncate group-hover:text-blue-600 transition-colors">Azure Estate <?php echo e($i); ?></h3>
                                ...
                                <div class="grid grid-cols-3 gap-4 py-6 border-y border-slate-100 mb-8">
                                    <div class="text-center group/spec">
                                        ...
                                        <div class="text-sm font-black text-slate-900"><?php echo e(3 + $i); ?></div>
                                        <div class="text-[10px] font-bold text-slate-400 uppercase tracking-tighter"><?php echo e(__('Beds')); ?></div>
                                    </div>
                                    <div class="text-center group/spec border-x border-slate-100 px-2">
                                        ...
                                        <div class="text-sm font-black text-slate-900"><?php echo e(2 + $i); ?></div>
                                        <div class="text-[10px] font-bold text-slate-400 uppercase tracking-tighter"><?php echo e(__('Baths')); ?></div>
                                    </div>
                                    <div class="text-center group/spec">
                                        <i class="fas fa-ruler-combined text-blue-500 mb-2 group-hover/spec:scale-125 transition-transform"></i>
                                        <div class="text-sm font-black text-slate-900"><?php echo e(3200 + ($i * 450)); ?></div>
                                        <div class="text-[10px] font-bold text-slate-400 uppercase tracking-tighter"><?php echo e(__('Sqft')); ?></div>
                                    </div>
                                </div>
    ...
    <section class="py-32 bg-slate-950 relative overflow-hidden">
        ...
        <div class="container mx-auto px-6 relative">
            <div class="text-center max-w-4xl mx-auto mb-20">
                <h2 class="text-4xl md:text-6xl font-black text-white mb-8"><?php echo e(__('Architectural Categories')); ?></h2>
                <p class="text-xl text-slate-400 leading-relaxed font-light"><?php echo e(__('Navigate through our curated ecosystem of property segments tailored for modern lifestyle needs.')); ?></p>
            </div>
                ...
                <?php $__currentLoopData = $segments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $segment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="#" class="group relative bg-white/5 border border-white/10 rounded-[2.5rem] p-10 text-center hover:bg-white/10 hover:border-white/20 transition-all duration-1000 transform hover:-translate-y-6">
                        ...
                        <div class="relative w-24 h-24 mx-auto mb-10 overflow-hidden">
                            <div class="absolute inset-0 bg-<?php echo e($segment['color']); ?>-600/20 blur-2xl rounded-full scale-0 group-hover:scale-150 transition-transform duration-1000"></div>
                            <div class="relative w-full h-full bg-white/5 border border-white/10 rounded-3xl flex items-center justify-center transition-all duration-700 group-hover:rotate-[360deg] group-hover:bg-<?php echo e($segment['color']); ?>-600 group-hover:shadow-[0_0_40px_rgba(37,99,235,0.4)]">
                                <i class="fas <?php echo e($segment['icon']); ?> text-3xl text-<?php echo e($segment['color']); ?>-400 group-hover:text-white transition-colors duration-700"></i>
                            </div>
                        </div>

                        <h3 class="text-xl font-black text-white mb-4 tracking-tight"><?php echo e(__($segment['name'])); ?></h3>
                        <div class="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 py-2 px-4 rounded-full bg-white/5 inline-block group-hover:bg-<?php echo e($segment['color']); ?>-600/20 group-hover:text-white transition-all">
                            <?php echo e($segment['listings']); ?> <?php echo e(__('Listings')); ?>
                ...
                <div class="relative z-10 grid grid-cols-1 lg:grid-cols-2 lg:items-center gap-20">
                    <div>
                        <h2 class="text-4xl md:text-6xl font-black text-white mb-10 leading-tight">
                            <?php echo e(__('Elevate Your')); ?> <br>
                            <span class="text-blue-500"><?php echo e(__('Real Estate Assets')); ?></span>
                        </h2>
                        <p class="text-xl text-slate-400 mb-14 leading-relaxed font-light">
                            <?php echo e(__('Whether you are looking to list a premium property or scale your portfolio, our visionary platform provides the ultimate ecosystem for success.')); ?>

                        </p>

                        <div class="flex flex-col sm:flex-row gap-6">
                            <a href="<?php echo e(route('register')); ?>" class="group/cta bg-white text-slate-900 px-12 py-5 rounded-2xl font-black uppercase tracking-widest text-[13px] hover:bg-blue-600 hover:text-white transition-all duration-500 flex items-center justify-center space-x-4 shadow-2xl hover:shadow-blue-500/40">
                                <span><?php echo e(__('Ignite Journey')); ?></span>
                                <i class="fas fa-chevron-right text-[10px] group-hover/cta:translate-x-2 transition-transform"></i>
                            </a>
                            <a href="<?php echo e(route('contact')); ?>" class="bg-white/10 backdrop-blur-xl border border-white/10 text-white px-12 py-5 rounded-2xl font-black uppercase tracking-widest text-[13px] hover:bg-white/20 transition-all duration-500 flex items-center justify-center">
                                <?php echo e(__('Consult Experts')); ?>
                        ...
                        <?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="bg-white/5 backdrop-blur-lg border border-white/5 p-8 rounded-[2.5rem] hover:border-blue-500/30 transition-all duration-700 group">
                                <div class="w-14 h-14 rounded-2xl bg-blue-600/20 flex items-center justify-center mb-6 group-hover:bg-blue-600 transition-all duration-500">
                                    <i class="fas <?php echo e($f['icon']); ?> text-xl text-blue-500 group-hover:text-white"></i>
                                </div>
                                <h3 class="text-white font-black text-lg mb-3 tracking-tight"><?php echo e(__($f['title'])); ?></h3>
                                <p class="text-slate-400 text-sm font-medium mb-6 leading-relaxed"><?php echo e(__($f['desc'])); ?></p>
                                <a href="<?php echo e(route($f['route'])); ?>" class="text-blue-500 text-[10px] font-black uppercase tracking-widest hover:text-white transition-colors flex items-center">
                                    <?php echo e(__('Discover More')); ?> <i class="fas fa-arrow-right ml-2 group-hover:translate-x-2 transition-transform"></i>
                                </a>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\larvel state big\resources\views/home.blade.php ENDPATH**/ ?>