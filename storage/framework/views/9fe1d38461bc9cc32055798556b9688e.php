<?php $__env->startSection('title', 'خريطة الروتات - Route Map'); ?>
                    ...
                    <div class="position-relative z-1">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-4">
                            ...
                            <div class="d-flex flex-wrap gap-2">
                                ...
                                <a href="<?php echo e(route('routes.export')); ?>" class="btn btn-success-modern">
        ...
        <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h2 class="stat-value"><?php echo e(count($routes)); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h2 class="stat-value"><?php echo e($routes->where('is_get', true)->count()); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h2 class="stat-value"><?php echo e($routes->where('is_post', true)->count()); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h2 class="stat-value"><?php echo e($routes->where('is_put', true)->count()); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h2 class="stat-value"><?php echo e($routes->where('is_delete', true)->count()); ?></h2>
                </div>
            </div>
        </div>
        <div class="col-lg-2 col-md-4 col-sm-6 mb-4">
            <div class="stat-card">
                ...
                <div class="stat-content">
                    ...
                    <h2 class="stat-value"><?php echo e($routes->where('is_api', true)->count()); ?></h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="glass-card overflow-hidden border-0">
                <div class="card-header-modern">
                    <div class="d-flex justify-content-between align-items-center px-4 py-3">
                        ...
                        <div id="routeCount" class="badge-count"><?php echo e(count($routes)); ?> روت</div>
                    </div>
                </div>
                    ...
                    <table class="table table-modern mb-0" id="routesTable">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $routes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="route-row" data-search="<?php echo e($route['uri']); ?> <?php echo e($route['name'] ?? ''); ?>" data-methods="<?php echo e(implode(',', $route['methods'])); ?>">
                                    <td>
                                        <div class="d-flex flex-wrap gap-1">
                                            <?php $__currentLoopData = $route['methods']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $method): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="method-badge <?php echo e(strtolower($method)); ?>"><?php echo e($method); ?></span>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="uri-container">
                                            <code class="uri-text"><?php echo e($route['uri']); ?></code>
                                            <?php if($route['is_api']): ?>
                                    ...
                                    <td>
                                        <?php if($route['name']): ?>
                                            <span class="name-badge"><?php echo e($route['name']); ?></span>
                                        <?php else: ?>
                                            <span class="text-muted small italic opacity-50">بدون اسم</span>
                                        <?php endif; ?>
                                    </td>
                                    <td>
                                        <div class="action-text" title="<?php echo e($route['action']); ?>">
                                            <?php echo e(Str::limit($route['action'], 50)); ?>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <?php if($route['is_get']): ?>
                                                <a href="<?php echo e(url($route['uri'])); ?>" class="btn-icon btn-view" target="_blank" title="عرض المسار">
                                                    <i class="fas fa-external-link-alt"></i>
                                                </a>
                                            <?php endif; ?>
                                            <?php if($route['name']): ?>
                                                <button class="btn-icon btn-copy" onclick="copyRouteName('<?php echo e($route['name']); ?>')" title="نسخ الاسم">
                                                    <i class="fas fa-copy"></i>
                                                </button>
                                                <button class="btn-icon btn-link" onclick="copyRouteUrl('<?php echo e(url($route['uri'])); ?>')" title="نسخ الرابط">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\larvel state big\resources\views/Route.blade.php ENDPATH**/ ?>