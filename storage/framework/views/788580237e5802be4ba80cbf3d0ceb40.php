                ...
                <div class="px-6 py-4">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <h1 class="text-xl font-semibold text-gray-800"><?php echo $__env->yieldContent('page-title', 'لوحة التحكم'); ?></h1>
                        </div>
                ...
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="text-sm text-gray-500">
                            &copy; <?php echo e(date('Y')); ?> <span class="font-semibold text-gray-800">نظام إدارة العقارات</span>.
...
<?php /**PATH F:\larvel state big\resources\views/admin/layouts/admin.blade.php ENDPATH**/ ?>