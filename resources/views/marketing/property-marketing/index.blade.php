...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">التسويق العقاري</h1>
            <p class="text-muted mb-0">إدارة حملات التسويق العقاري</p>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ route('marketing.property-marketing.show', $campaign) }}" class="btn btn-sm btn-outline-primary">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ route('marketing.property-marketing.edit', $campaign) }}" class="btn btn-sm btn-outline-secondary">
...
<script>
    ...
    function deleteCampaign(id) {
        if (confirm('هل أنت متأكد من حذف هذه الحملة؟')) {
            fetch(`/marketing/property-marketing/${id}`, {
                method: 'DELETE',
                headers: {
            ...
            .catch(error => {
                ...
                alert('حدث خطأء أثناء حذف الحملة');
            });
        }
    }
