...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
    ...
    <div class="max-w-md w-full relative z-10">
        ...
        <div class="text-center mb-10 relative">
            ...
            <div class="space-y-3">
                ...
                <p class="text-xl text-gray-600 leading-relaxed">
                    {{ __('Sign in to your Real Estate Pro account') }}
                </p>
                <div class="flex items-center justify-center space-x-2 text-gray-500 text-sm">
                    <span>{{ __('New to Real Estate Pro?') }}</span>
                    <a href="{{ route('register') }}" class="text-blue-600 hover:text-blue-700 font-semibold transition-all duration-200 hover:underline underline-offset-4">
        ...
        <!-- Login Form -->
        <form class="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 overflow-hidden transform hover:scale-[1.01] transition-all duration-300" action="{{ route('login') }}" method="POST">
            @csrf
            ...
            <div class="p-8 space-y-8">
                ...
                <div class="space-y-6">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h3 class="text-2xl font-bold text-gray-900">{{ __('Login Information') }}</h3>
                            <p class="text-sm text-gray-500 mt-1">{{ __('Enter your credentials to continue') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-3 group">
                            ...
                            <div class="relative">
                                ...
                                <div class="absolute inset-y-0 right-0 pr-4 flex items-center space-x-2">
                                    ...
                                    <button type="button" class="text-gray-400 hover:text-gray-600 focus:outline-none focus:text-blue-500 transition-colors duration-200 p-1" title="{{ __('Password requirements') }}">
                        ...
                        <div class="flex items-center justify-between py-2">
                            ...
                            <div class="text-sm">
                                <a href="{{ route('password.request') }}" class="text-blue-600 hover:text-blue-700 font-medium transition-all duration-200 hover:underline underline-offset-4 flex items-center space-x-1">
