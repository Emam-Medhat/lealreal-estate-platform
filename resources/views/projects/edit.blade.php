...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">تعديل المشروع - {{ $project->name }}</h1>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('projects.update', $project) }}">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('project_type') is-invalid @enderror" 
                                ...
                                <option value="residential" {{ old('project_type', $project->project_type) == 'residential' ? 'selected' : '' }}>سكني</option>
                                <option value="commercial" {{ old('project_type', $project->project_type) == 'commercial' ? 'selected' : '' }}>تجاري</option>
                                <option value="mixed" {{ old('project_type', $project->project_type) == 'mixed' ? 'selected' : '' }}>مختلط</option>
                                <option value="industrial" {{ old('project_type', $project->project_type) == 'industrial' ? 'selected' : '' }}>صناعي</option>
                            </select>
                            @error('project_type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('budget') is-invalid @enderror" 
                                   id="budget" name="budget" value="{{ old('budget', $project->budget) }}" step="0.01" min="0" required>
                            @error('budget')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('total_units') is-invalid @enderror" 
                                   id="total_units" name="total_units" value="{{ old('total_units', $project->total_units) }}" min="0">
                            @error('total_units')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('total_area') is-invalid @enderror" 
                                   id="total_area" name="total_area" value="{{ old('total_area', $project->total_area) }}" step="0.01" min="0">
                            @error('total_area')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="row mb-4">
                    <div class="col-12">
                        <h5 class="mb-3">مميزات المشروع</h5>
...
function addFeature() {
    ...
    featureRow.className = 'row mb-2 feature-row';
