...
<script>
const apiRoutes = {
    list: "{{ route('modules.list') }}",
    details: "{{ route('modules.details', ['moduleKey' => ':key']) }}",
    toggle: "{{ route('modules.toggle', ['moduleKey' => ':key']) }}",
    configure: "{{ route('modules.configure', ['moduleKey' => ':key']) }}"
};
