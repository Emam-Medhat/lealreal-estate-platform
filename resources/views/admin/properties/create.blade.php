        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="page-header">
                    ...
                    <a href="{{ route('admin.properties.index') }}" class="btn-back">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon">
                                        ...
                                        <select class="form-select @error('property_type') is-invalid @enderror"
                                            ...
                                            <option value="1" {{ old('property_type') == '1' ? 'selected' : '' }}>Apartment</option>
                                            <option value="2" {{ old('property_type') == '2' ? 'selected' : '' }}>Villa</option>
                                            <option value="3" {{ old('property_type') == '3' ? 'selected' : '' }}>House</option>
                                            <option value="4" {{ old('property_type') == '4' ? 'selected' : '' }}>Land</option>
                                            <option value="5" {{ old('property_type') == '5' ? 'selected' : '' }}>Commercial</option>
                                        </select>
                                    </div>
                                    @error('property_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
