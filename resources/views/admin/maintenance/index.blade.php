...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-7xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-800">{{ $maintenance['last_run']->format('M j, Y H:i') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-800">{{ $maintenance['next_scheduled']->format('M j, Y H:i') }}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            ...
            <form action="{{ route('admin.maintenance.run') }}" method="POST">
                @csrf
