    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800 mb-2">Edit Company</h1>
                    <p class="text-gray-600">Update company information for {{ $company->name }}</p>
                </div>
                <div>
                    <a href="{{ route('admin.companies.show', $company->id) }}" class="text-blue-600 hover:text-blue-800">
        ...
        <form action="{{ route('admin.companies.update', $company->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="type" id="type" 
                            ...
                            <option value="brokerage" {{ old('type', $company->type) == 'brokerage' ? 'selected' : '' }}>Brokerage</option>
                            <option value="property_management" {{ old('type', $company->type) == 'property_management' ? 'selected' : '' }}>Property Management</option>
                            <option value="construction" {{ old('type', $company->type) == 'construction' ? 'selected' : '' }}>Construction</option>
                            <option value="investment" {{ old('type', $company->type) == 'investment' ? 'selected' : '' }}>Investment</option>
                            <option value="consulting" {{ old('type', $company->type) == 'consulting' ? 'selected' : '' }}>Consulting</option>
                        </select>
                        @error('type')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" id="description" rows="4" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">{{ old('description', $company->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="date" name="founded_date" id="founded_date" value="{{ old('founded_date', $company->founded_date) }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        @error('founded_date')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <input type="number" name="employee_count" id="employee_count" value="{{ old('employee_count', $company->employee_count) }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                               required>
                    ...
                    <div>
                        ...
                        <input type="number" name="annual_revenue" id="annual_revenue" value="{{ old('annual_revenue', $company->annual_revenue) }}" 
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="country" id="country" value="{{ old('country', $company->country ?? 'Saudi Arabia') }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        @error('country')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="md:col-span-2">
                        <label class="flex items-center">
                            <input type="checkbox" name="is_featured" value="1" {{ old('is_featured', $company->is_featured) ? 'checked' : '' }}
                    ...
                    <div class="md:col-span-2">
                        <label class="flex items-center">
                            <input type="checkbox" name="is_verified" value="1" {{ old('is_verified', $company->is_verified) ? 'checked' : '' }}
                                   class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                    ...
                    <div>
                        ...
                        <select name="verification_level" id="verification_level" 
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                required>
                            <option value="0" {{ old('verification_level', $company->verification_level) == '0' ? 'selected' : '' }}>Not Verified</option>
                            <option value="1" {{ old('verification_level', $company->verification_level) == '1' ? 'selected' : '' }}>Basic</option>
                            <option value="2" {{ old('verification_level', $company->verification_level) == '2' ? 'selected' : '' }}>Standard</option>
                            <option value="3" {{ old('verification_level', $company->verification_level) == '3' ? 'selected' : '' }}>Premium</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="number" name="rating" id="rating" value="{{ old('rating', $company->rating) }}" 
                    ...
                    <div>
                        ...
                        <input type="number" name="total_reviews" id="total_reviews" value="{{ old('total_reviews', $company->total_reviews) }}" 
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="subscription_expires_at" id="subscription_expires_at" value="{{ old('subscription_expires_at', $company->subscription_expires_at) }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="file" name="logo_url" id="logo_url" accept="image/*"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                        @if($company->logo_url)
                            <p class="mt-1 text-sm text-gray-500">Current: <a href="{{ asset('storage/' . $company->logo_url) }}" target="_blank" class="text-blue-600">View Logo</a></p>
                        @else
                    ...
                    <div>
                        ...
                        @if($company->cover_image_url)
                            <p class="mt-1 text-sm text-gray-500">Current: <a href="{{ asset('storage/' . $company->cover_image_url) }}" target="_blank" class="text-blue-600">View Cover</a></p>
                        @else
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="api_key" id="api_key" value="{{ old('api_key', $company->api_key) }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <div>
                        ...
                        <input type="url" name="webhook_url" id="webhook_url" value="{{ old('webhook_url', $company->webhook_url) }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500"
            ...
            <div class="bg-white rounded-lg shadow-sm p-6">
                <div class="flex justify-end space-x-4">
                    <a href="{{ route('admin.companies.show', $company->id) }}" class="px-4 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50 transition-colors">
                        Cancel
                    </a>
