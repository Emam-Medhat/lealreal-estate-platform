                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    ...
                    <div class="border border-gray-100 rounded-xl p-5 hover:shadow-md transition-shadow bg-gray-50/30">
                        ...
                        <div class="space-y-2.5">
                            ...
                            <a href="{{ route('maintenance.reports') }}"
                                class="flex items-center text-sm text-black no-underline hover:no-underline transition-colors">
                    ...
                    <div class="border border-gray-100 rounded-xl p-5 hover:shadow-md transition-shadow bg-gray-50/30">
                        ...
                        <div class="space-y-2.5">
                            ...
                            <a href="{{ route('iot.automations.index') }}"
                                class="flex items-center text-sm text-black no-underline hover:no-underline transition-colors">
                                <i class="fas fa-cogs w-5"></i> Automations
                            </a>
                            <a href="{{ route('iot.energy.dashboard') }}"
                                class="flex items-center text-sm text-black no-underline hover:no-underline transition-colors">
                    ...
                    <div class="border border-gray-100 rounded-xl p-5 hover:shadow-md transition-shadow bg-gray-50/30">
                        ...
                        <div class="space-y-2.5">
                            ...
                            <a href="{{ route('enterprise.accounts') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-slate-600 transition-colors">
                                <i class="fas fa-users-cog w-5"></i> Accounts
                            </a>
                            <a href="{{ route('enterprise.subscriptions') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-slate-600 transition-colors">
                                <i class="fas fa-file-invoice w-5"></i> Subscriptions
                            </a>
                            <a href="{{ route('enterprise.reports') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-slate-600 transition-colors">
                    ...
                    <div class="border border-gray-100 rounded-xl p-5 hover:shadow-md transition-shadow bg-gray-50/30">
                        ...
                        <div class="space-y-2.5">
                            ...
                            <a href="{{ route('blockchain.transactions.index') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-indigo-600 transition-colors">
                                <i class="fas fa-exchange-alt w-5"></i> Transactions
                            </a>
                            <a href="{{ route('blockchain.smartcontracts.index') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-indigo-600 transition-colors">
                    ...
                    <div class="border border-gray-100 rounded-xl p-5 hover:shadow-md transition-shadow bg-gray-50/30">
                        ...
                        <div class="space-y-2.5">
                            <a href="{{ route('analytics-alt.dashboard') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-indigo-600 transition-colors">
                                <i class="fas fa-microchip w-5"></i> AI Insights
                            </a>
                            <a href="{{ route('analytics-alt.market.index') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-indigo-600 transition-colors">
                                <i class="fas fa-globe-americas w-5"></i> Market Trends
                            </a>
                            <a href="{{ route('analytics-alt.behavior.index') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-indigo-600 transition-colors">
                                <i class="fas fa-user-check w-5"></i> User Behavior
                            </a>
                            <a href="{{ route('analytics-alt.heatmap.index') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-indigo-600 transition-colors">
                    ...
                    <div class="border border-gray-100 rounded-xl p-5 hover:shadow-md transition-shadow bg-gray-50/30">
                        ...
                        <div class="space-y-2.5">
                            ...
                            <a href="{{ route('ads.placements.index') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-pink-600 transition-colors">
                                <i class="fas fa-layer-group w-5"></i> Placements
                            </a>
                            <a href="{{ route('ads.budgets.index') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-pink-600 transition-colors">
                                <i class="fas fa-money-bill-wave w-5"></i> Budgets
                            </a>
                            <a href="{{ route('ads.promoted-listings.index') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-pink-600 transition-colors">
                    ...
                    <div class="border border-gray-100 rounded-xl p-5 hover:shadow-md transition-shadow bg-gray-50/30">
                        ...
                        <div class="space-y-2.5">
                            ...
                            <a href="{{ route('ads.analytics.dashboard') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-rose-600 transition-colors">
                    ...
                    <div class="border border-gray-100 rounded-xl p-5 hover:shadow-md transition-shadow bg-gray-50/30">
                        ...
                        <div class="space-y-2.5">
                            <a href="{{ route('analytics-alt.bigdata.index') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-cyan-600 transition-colors">
                            ...
                            <a href="{{ route('analytics-alt.sentiment.index') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-cyan-600 transition-colors">
                    ...
                    <div class="border border-gray-100 rounded-xl p-5 hover:shadow-md transition-shadow bg-gray-50/30">
                        ...
                        <div class="space-y-2.5">
                            <a href="{{ route('investors.crowdfunding.index') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-violet-600 transition-colors">
                                <i class="fas fa-users w-5"></i> Crowdfunding
                            </a>
                            <a href="{{ route('investors.defi.loans.index') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-violet-600 transition-colors">
                    ...
                    <div class="border border-gray-100 rounded-xl p-5 hover:shadow-md transition-shadow bg-gray-50/30">
                        ...
                        <div class="space-y-2.5">
                            <a href="{{ route('developer.bim.index') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-orange-600 transition-colors">
                                <i class="fas fa-cube w-5"></i> BIM Models
                            </a>
                            <a href="{{ route('developer.construction-updates.index') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-orange-600 transition-colors">
                                <i class="fas fa-tools w-5"></i> Construction
                            </a>
                            <a href="{{ route('developer.permits.index') }}"
                                class="flex items-center text-sm text-gray-600 hover:text-orange-600 transition-colors">
                    ...
                    <div class="border border-gray-100 rounded-xl p-5 hover:shadow-md transition-shadow bg-gray-50/30">
                        ...
                        <div class="space-y-2.5">
                            ...
                            <a href="{{ route('subscriptions.usage.index', ['subscription' => 1]) }}"
                                class="flex items-center text-sm text-gray-600 hover:text-fuchsia-600 transition-colors">
                    ...
                    <div class="border border-gray-100 rounded-xl p-5 hover:shadow-md transition-shadow bg-gray-50/30">
                        ...
                        <div class="space-y-2.5">
                            ...
                            <a href="{{ route('agents.commissions.index', ['agent' => 1]) }}"
                                class="flex items-center text-sm text-gray-600 hover:text-blue-600 transition-colors">
