                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('user_type') is-invalid @enderror" 
                                        ...
                                        <option value="agent" {{ old('user_type') == 'agent' ? 'selected' : '' }}>Real Estate Agent</option>
                                        ...
                                        <option value="buyer" {{ old('user_type') == 'buyer' ? 'selected' : '' }}>Property Buyer</option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('kyc_status') is-invalid @enderror" 
                                        ...
                                        <option value="submitted" {{ old('kyc_status') == 'submitted' ? 'selected' : '' }}>Submitted</option>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('profile_bio') is-invalid @enderror" 
                                              id="profile_bio" name="profile[bio]" rows="3">{{ old('profile_bio') }}</textarea>
                                    @error('profile_bio')
                                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control @error('profile_website') is-invalid @enderror" 
                                           id="profile_website" name="profile[website]" value="{{ old('profile_website') }}">
