...
<div class="flex h-screen bg-gray-50">
    ...
    <aside class="w-64 bg-white border-r border-gray-200 overflow-y-auto sticky top-0 h-screen">
        ...
        <nav class="p-4 space-y-2">
            <a href="{{ route('requests.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg bg-blue-50 text-blue-700 font-semibold border-r-4 border-blue-600">
                <i class="fas fa-chart-line w-5"></i>
                <span>مراقبة الطلبات</span>
            </a>
            <a href="{{ route('requests.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition">
            ...
            <div class="border-t border-gray-200 my-4 pt-4">
                ...
                <a href="{{ url('/dashboard') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition">
                    <i class="fas fa-tachometer-alt w-5"></i>
                    <span>لوحة التحكم</span>
                </a>
                <a href="{{ url('/settings') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition">
                    <i class="fas fa-cog w-5"></i>
                    <span>الإعدادات</span>
                </a>
                <a href="{{ url('/profile') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition">
                    <i class="fas fa-user w-5"></i>
                    <span>الملف الشخصي</span>
                </a>
                <a href="{{ url('/logout') }}" class="flex items-center gap-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition">
                    ...
                    <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <h3 class="text-3xl font-bold text-gray-900 mt-1" id="totalRequests">{{ $stats['total'] ?? 0 }}</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition border-l-4 border-l-yellow-500">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <h3 class="text-3xl font-bold text-gray-900 mt-1" id="pendingRequests">{{ $stats['pending'] ?? 0 }}</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition border-l-4 border-l-cyan-500">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <h3 class="text-3xl font-bold text-gray-900 mt-1" id="processingRequests">{{ $stats['processing'] ?? 0 }}</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition border-l-4 border-l-red-500">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <h3 class="text-3xl font-bold text-gray-900 mt-1" id="failedRequests">{{ $stats['failed'] ?? 0 }}</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition border-l-4 border-l-green-500">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <h3 class="text-3xl font-bold text-gray-900 mt-1" id="completedRequests">{{ $stats['completed'] ?? 0 }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="bg-white rounded-lg border border-gray-200 p-6 hover:shadow-lg transition cursor-pointer border-l-4 border-l-{{ getStatusColor($request->status) }}-500" onclick="showRequestDetails('{{ $request->id }}')">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-lg font-bold text-gray-900">{{ $request->response_time ? number_format($request->response_time, 0) . 'ms' : '-' }}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-700">{{ $request->created_at->format('H:i') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                                <div class="flex items-center gap-3">
                                    @if($request->user)
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-gray-500">{{ substr($request->user->email, 0, 20) }}</p>
                                        </div>
                                    @else
                                ...
                                <div class="flex gap-2" onclick="event.stopPropagation();">
                                    <button class="w-9 h-9 rounded-lg bg-blue-100 text-blue-600 hover:bg-blue-200 transition flex items-center justify-center" title="عرض التفاصيل" onclick="showRequestDetails({{ $request->id }})">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                    @if($request->status === 'failed')
                                        <button class="w-9 h-9 rounded-lg bg-yellow-100 text-yellow-600 hover:bg-yellow-200 transition flex items-center justify-center" title="إعادة المحاولة" onclick="retryRequest({{ $request->id }})">
                                            <i class="fas fa-redo"></i>
                                        </button>
                                    @endif
                                </div>
