            ...
            <div class="flex justify-between items-center">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-purple-100">{{ $report->description }}</p>
                    </div>
                </div>
                <div class="flex items-center space-x-3">
                    ...
                    <a href="{{ route('reports.market.data') }}" class="bg-white bg-opacity-20 hover:bg-opacity-30 text-white px-4 py-2 rounded-lg transition-colors">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <div class="text-2xl font-bold text-gray-800">${{ number_format($report->average_property_price ?? 250000, 0) }}</div>
                        </div>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <div class="text-sm text-gray-600">السعر المتوسط</div>
                            <div class="text-2xl font-bold text-gray-800">${{ number_format($report->median_property_price ?? 225000, 0) }}</div>
                        </div>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <div class="text-sm text-gray-600">إجمالي العقارات</div>
                            <div class="text-2xl font-bold text-gray-800">{{ $report->total_listings ?? 150 }}</div>
                        </div>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <div class="text-sm text-gray-600">إجمالي المبيعات</div>
                            <div class="text-2xl font-bold text-gray-800">{{ $report->total_sales ?? 75 }}</div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                            ...
                            <div class="text-right">
                                <div class="font-semibold">${{ number_format(300000, 0) }}</div>
                        ...
                        <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                            ...
                            <div class="text-right">
                                <div class="font-semibold">${{ number_format(200000, 0) }}</div>
                        ...
                        <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                            ...
                            <div class="text-right">
                                <div class="font-semibold">${{ number_format(250000, 0) }}</div>
                        ...
                        <div class="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
                            ...
                            <div class="text-right">
                                <div class="font-semibold">${{ number_format(500000, 0) }}</div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <div class="font-medium">{{ $report->market_area ?? 'الرياض' }}</div>
                        </div>
                        <div>
                            <div class="text-sm text-gray-600">الفترة</div>
                            <div class="font-medium">
                                {{ $report->period_start ? $report->period_start->format('Y-m-d') : 'N/A' }} - {{ $report->period_end ? $report->period_end->format('Y-m-d') : 'N/A' }}
                            </div>
                        </div>
                        <div>
                            <div class="text-sm text-gray-600">تاريخ الإنشاء</div>
                            <div class="font-medium">{{ $report->created_at ? $report->created_at->format('Y-m-d H:i') : 'N/A' }}</div>
                        </div>
                        <div>
                            <div class="text-sm text-gray-600">التنسيق</div>
                            <div class="font-medium">{{ strtoupper($report->format ?? 'PDF') }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="space-y-3">
                        <a href="{{ route('reports.market.data') }}" class="w-full block text-center bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors">
                            <i class="fas fa-download ml-2"></i>
                            تحميل التقرير
                        </a>
