        ...
        <div class="bg-gradient-to-r from-purple-600 to-indigo-700 rounded-lg shadow-lg p-6 mb-6 text-white">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-3">
                    <a href="{{ route('reports.market.create') }}" class="bg-white bg-opacity-20 hover:bg-opacity-30 text-white px-4 py-2 rounded-lg transition-colors">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 hover:shadow-lg transition-shadow">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800">{{ $stats['total_reports'] ?? 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 hover:shadow-lg transition-shadow">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800">{{ $stats['avg_growth'] ?? '0%' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 hover:shadow-lg transition-shadow">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800">{{ $stats['available_properties'] ?? 0 }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 hover:shadow-lg transition-shadow">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800">${{ number_format($stats['avg_price'] ?? 0, 0) }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div class="flex space-x-2">
                        <a href="{{ route('reports.market.index', ['period' => 'week']) }}" 
                           class="px-4 py-2 rounded-lg {{ $period == 'week' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700' }} transition-colors">
                            أسبوع
                        </a>
                        <a href="{{ route('reports.market.index', ['period' => 'month']) }}" 
                           class="px-4 py-2 rounded-lg {{ $period == 'month' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700' }} transition-colors">
                            شهر
                        </a>
                        <a href="{{ route('reports.market.index', ['period' => 'quarter']) }}" 
                           class="px-4 py-2 rounded-lg {{ $period == 'quarter' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700' }} transition-colors">
                            ربع سنة
                        </a>
                        <a href="{{ route('reports.market.index', ['period' => 'year']) }}" 
                           class="px-4 py-2 rounded-lg {{ $period == 'year' ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-700' }} transition-colors">
                            سنة
                        </a>
                    </div>
                </div>
            ...
            <div class="overflow-x-auto">
                            ...
                            @foreach($reports as $report)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('reports.market.show', $report->id) }}" class="text-blue-600 hover:text-blue-900">عرض</a>
                                        <a href="{{ route('reports.market.data') }}" class="ml-4 text-green-600 hover:text-green-900">تحميل</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                        ...
                        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                            <div>
                                <p class="text-sm text-gray-700">
                                    عرض <span class="font-medium">{{ $reports->firstItem() }}</span>
                                    إلى <span class="font-medium">{{ $reports->lastItem() }}</span>
                                    من <span class="font-medium">{{ $reports->total() }}</span> نتائج
                                </p>
                            </div>
                            <div>
                                {{ $reports->links() }}
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <a href="{{ route('reports.market.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors">
