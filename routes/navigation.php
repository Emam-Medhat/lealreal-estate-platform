...
return [
    ...
    'reports' => [
        ...
        'financial' => ['route' => 'reports.financial', 'label' => 'التقارير المالية', 'icon' => 'calculator'],
        'market' => ['route' => 'reports.market', 'label' => 'تقارير السوق', 'icon' => 'chart-bar'],
        'custom' => ['route' => 'reports.custom', 'label' => 'تقارير مخصصة', 'icon' => 'cog'],
