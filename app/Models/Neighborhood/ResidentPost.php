...
class ResidentPost extends Model
{
    use SoftDeletes;
    ...
    /**
     * Scope a query to get posts by priority.
     */
    ...
    /**
     * Scope a query to get posts today.
     */
    ...
    /**
     * Scope a query to get posts this week.
     */
    ...
    /**
     * Scope a query to get posts this month.
     */
    ...
    /**
     * Scope a query to get posts that allow comments.
     */
    ...
    /**
     * Scope a query to get posts that have expired.
     */
    ...
    /**
     * Scope a query to get posts that are still active.
     */
    ...
    public function getPostTypeLabelAttribute(): string
    {
        ...
        return $types[$this->post_type] ?? 'غير معروف';
    }
    ...
    /**
     * Check if the post is high priority.
     */
    ...
    /**
     * Check if the post is medium priority.
     */
    ...
    /**
     * Check if the post is low priority.
     */
    ...
    /**
     * Check if the post has related links.
     */
    ...
    /**
     * Check if the post has social sharing.
     */
    ...
    /**
     * Check if the post is popular.
     */
    public function isPopular(): bool
    {
        return $this->view_count > 100 || $this->like_count > 10 || $this->comment_count > 5;
    }
    ...
    {
        return $this->view_count > 500 || $this->like_count > 50 || $this->comment_count > 20;
    }
    ...
    public function getEngagementScore(): float
    {
        ...
        $viewScore = min($this->view_count / 1000, 1) * 0.3;
        $likeScore = min($this->like_count / 100, 1) * 0.3;
        $commentScore = min($this->comment_count / 50, 1) * 0.3;
        $shareScore = min($this->share_count / 25, 1) * 0.1;
    ...
    public function getPopularityScore(): float
    {
        ...
        // Add recency bonus (newer posts get higher score)
