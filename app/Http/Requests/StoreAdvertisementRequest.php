...
class StoreAdvertisementRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        if ($this->input('campaign_id') === 'new') {
            $rules = array_merge($rules, [
                'new_campaign_name' => 'required|string|max:255',
                'new_campaign_description' => 'nullable|string|max:500',
                'new_campaign_objective' => 'required|in:awareness,traffic,conversions,engagement'
            ]);
        }
    ...
    public function messages()
    {
        return [
            ...
            'type.required' => 'حقل نوع الإعلان مطلوب',
            ...
            'new_campaign_name.required' => 'حقل اسم الحملة الجديدة مطلوب',
            'new_campaign_objective.required' => 'حقل هدف الحملة الجديدة مطلوب'
        ];
    }
}
