...
class UpdatePropertyRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'price_change_reason.max' => 'Price change reason may not be greater than 500 characters.',
            'status_change_reason.max' => 'Status change reason may not be greater than 500 characters.',
        ];
    }
